...
export const Contact = () => {
  ...
  return (
    <main className="form form__contact">
      <h1 className='text p-5'>Get in touch!</h1>
      <div>
        <div className="div__contact">
          <AiOutlineMail />
          <a href="mailto:appu.ananthaneni@gmail.com">Send an Email</a>
        </div>
        <div className="div__contact">
          <FaLinkedin />
          <a
            href="https://www.linkedin.com/in/lakshmi-ananthaneni1/"
            target="_blank"
            rel="noreferrer"
          >
            Find me on LinkedIn
        ...
        <div className="div__contact">
          <FaGithub />
          <a
            href="https://github.com/Lakshmi-Ananthaneni/Blog-project"
            target="_blank"
            rel="noreferrer"
          >
